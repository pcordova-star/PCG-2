...
export default function SafetyChecklistRecordsPage() {
    ...
    useEffect(() => {
        ...
        const baseQuery = collection(firebaseDb, "safetyChecklistRecords");
      ...
      <header className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Historial de todos los formularios de seguridad completados.
          </p>
        </div>
      </header>
       <Card>
       ...
       <Card>
        <CardHeader>
          <CardTitle>Historial de Registros de Seguridad</CardTitle>
        </CardHeader>
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-16 border-2 border-dashed rounded-lg">
                <p className="text-muted-foreground">No se han completado formularios de seguridad que coincidan con el filtro.</p>
            </div>
          ) : (
             <Table>
              <TableHeader>
                  ...
                  <TableRow key={record.id}>
                    ...
                    <TableCell className="text-right">
                      <Button asChild variant="outline" size="sm">
                        <Link href={`/prevencion/safety-checklists/records/${record.id}`}>
