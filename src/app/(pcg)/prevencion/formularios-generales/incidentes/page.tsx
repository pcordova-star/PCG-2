...
export default function ReportarIncidentePage() {
    ...
    const handleSave = async (e: FormEvent) => {
        ...
        setIsSaving(true);
        try {
            const incidentesCollection = collection(firebaseDb, 'incidentes'); // Asumiendo una colección raíz
            const dataToSave = {
                ...incidente,
                companyId: companyId,
                createdBy: user.uid,
            ...
            router.push(`/prevencion/hallazgos`); // O a una página de detalle de incidente
        } catch (error) {
